# Open Spot Forecast — Documentation Index

Welcome to the Open Spot Forecast documentation. This index is the canonical
table of contents for the project. It is also used to generate the GitHub wiki
sidebar (`_Sidebar.md`), so the table below must stay the first table in this
file.
